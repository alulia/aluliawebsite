...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
		<title><?php echo $_SERVER["SERVER_NAME"]; ?> is hosted by Axxess</title>
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<meta name="Keywords" CONTENT="<?php echo $_SERVER["SERVER_NAME"]; ?>, linux hosting, windows hosting, web hosting, web site hosting, domain name, business hosting, affordable hosting, domains, hosting service, affordable web hosting, best web hosting, hosting provider, web hosting company, reseller, linux, MySQL, Cpanel, Plesk" />
		<meta name="Description" CONTENT="<?php echo $_SERVER["SERVER_NAME"]; ?> is hosted by Axxess" />
		...
		<meta name="Copyright" CONTENT="<?php echo date('Y'); ?> Axxess DSL" />
